            ...
            using (SaveFileDialog sfd = new SaveFileDialog() { Filter = "PDF file|*.pdf", ValidateNames = true })
              {
                  if (sfd.ShowDialog() == DialogResult.OK)
                  {
                      ...
                      try
                      {
                          ...
                          iTextSharp.text.Image jpg = iTextSharp.text.Image.GetInstance("C:/Users/ASUS/Desktop/New folder/App/Resources/Untitled.png");
                        ...
                        Phrase Time_phrase = new Phrase();
                        Chunk chunkT1 = new Chunk("Time :   ", paraFont2);
                        Chunk chunkT2 = new Chunk(timeTextBox.Text, paraFont1);
                        chunkT2.SetUnderline(1.2f, -1.5f);

                        Time_phrase.Add(chunkT1);
                        Time_phrase.Add(chunkT2);
                        ...
                        Phrase id_phrase = new Phrase();
                          ...
                          Paragraph pT = new iTextSharp.text.Paragraph(Time_phrase);
